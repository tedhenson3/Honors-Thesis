...
prep.min.15.16 <- read_csv("prep.min.15-17.csv")
prep.min.16.17 <- read_csv("prep.min.16-17.csv")
prep.min.17.18 <- read_csv("prep.min.17-18.csv")
...
write.csv(minutes.data, file = 'prep.minutes.csv', row.names =  F)