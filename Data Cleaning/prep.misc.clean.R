...
prep.min.15.16 <- read_csv("prep.misc.15-16.csv")
prep.min.16.17 <- read_csv("prep.misc.16-17.csv")
prep.min.17.18 <- read_csv("prep.misc.17-18.csv")
...
write.csv(minutes.data, file = 'prep.misc.csv', row.names =  F)