...
```{r, echo = F, eval = T, include=F}
r2.table = read_csv("~/Honors Thesis/Predictions/All R2 (raw ws LOOCV 3).csv")
...
summary(mod)
```
# Best ESPN Model Versus Best Stacked Model
```{r}
...
ggplot(full, aes(x = full.error, 
 ...
 # geom_abline(slope = 1) + 
  ...
  ylim(-6, 6) +
  xlim(-6, 6)  + 
  ylab('ESPN SVM Residual') +  
  xlab('Full Stacked Residual')  + theme_bw()
