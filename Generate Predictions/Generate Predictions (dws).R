...
source('~/Honors Thesis/Data Cleaning/Prepping Data for Modeling (dws).R')
...
espn.dws.predictions = data.frame(
  #pls = NA,
  lasso = espn.pred.lm,
  # ridge = c(rep(0, 185)),
  # rf = c(rep(0, 185)),
...
prep.dws.predictions = data.frame(pls = prep.pred.pls,
...
aau.dws.predictions = data.frame(pls = aau.pred.pls,
...
full.dws.predictions = data.frame(pls = full.pred.pls,
...
aau.espn.dws.predictions = data.frame(pls = aau.espn.pred.pls,
...
prep.espn.dws.predictions = data.frame(pls = prep.espn.pred.pls,
...
aau.prep.dws.predictions = data.frame(pls = aau.prep.pred.pls,
...
espn.dws.predictions = data.frame(pls = NA,
                                  lasso = espn.pred.lm,
                                  ridge = NA,
                                  rf = NA,
                                  earth = espn.pred.earth,
